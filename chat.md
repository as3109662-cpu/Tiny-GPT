...
### assistant
TinyGPT is a small GPT-style language model written in pure NumPy. It is meant to train and run on a phone.
...
### assistant
The phone preset is sized for a few hundred megabytes. Keep batch size at 4 and use two BLAS threads.
